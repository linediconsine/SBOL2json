...
var snapgeneToJson = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(fileObj) {
    var _this = this;
              ...
              return _regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 64:
                      b = _context3.sent;
                      name = get(b, "Notes.CustomMapLabel[0]");

                      if (name) {
                        data.name = name;
                      }

                      description = get(b, "Notes.Description[0]");
